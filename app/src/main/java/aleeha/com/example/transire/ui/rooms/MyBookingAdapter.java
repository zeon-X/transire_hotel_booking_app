...
public class MyBookingAdapter extends RecyclerView.Adapter<MyBookingAdapter.MyBookingViewHolder> {
    ...
    Context context;
    String[] roomName,arrivalDate, departureDate, price;

    public MyBookingAdapter(Context context, String[] roomName, String[] arrivalDate, String[] departureDate, String[] price) {
    ...
    public void onBindViewHolder(@NonNull MyBookingViewHolder holder, int i) {
        holder.tv_rn.setText(roomName[i]);
        holder.tv_ad.setText("Arrival Date: "+arrivalDate[i]);
        holder.tv_dd.setText("Departure Date: "+departureDate[i]);
